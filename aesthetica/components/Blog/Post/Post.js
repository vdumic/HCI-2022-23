  ...
  return (
    <div className="grid sm:grid-cols-1 lg:grid-cols-12 lg:mx-24 sm:mx-8 lg:gap-20">
      <div className="lg:col-span-7 sm:order-3 md:order-3 sm:my-10">
        <Image alt="post" src={post.image.url} style={{ objectFit: 'cover' }} width="900" height="600" className="lg:h-[380px] sm:h-[180px]"/>
      </div>
      ...
      <div className="sm:hidden md:hidden col-span-5 lg:h-[380px]">
        ...
        <p className="text-7xl sm:text-3xl md:texl-xl font-semibold">{post.title}</p>
      </div>
