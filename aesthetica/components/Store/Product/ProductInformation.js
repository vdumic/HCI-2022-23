...
const ProductInformation = ({ title, price }) => {
  return (
    <div className="flex flex-col lg:w-3/4 lg:ml-36 items-start">
      ...
      <QuantityCounter />
      <button className="flex justify-center bg-[#252526] hover:bg-[#3e3e42] hover:border-[#3e3e42] text-gray-100 font-medium mt-8 py-2 px-14 border-2 border-[#252526] rounded-full shadow-xl">
        Add to cart
      </button>
    </div>
  );
