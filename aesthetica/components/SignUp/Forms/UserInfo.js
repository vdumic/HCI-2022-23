  ...
  return (
    ...
    >
      <Form className="flex flex-col w-full justify-center items-center">
        <div className="flex lg:w-1/4 justify-between sm:w-full sm:px-8 sm:flex-col ">
        ...
        <div className="flex flex-col lg:w-1/4 items-start mb-2 sm:w-full sm:px-8">
        ...
        <div className="flex flex-col lg:w-1/4 sm:w-full sm:px-8 items-start mb-6">
